...
### Ближайшее  
1. Масштабировать генетические признаки.
2. Рефакторинг:
...
4. Обсудить данные, результаты первичого изучения, корреляции, аномалии - возможно, исправить в данных опечатки.

### Обший план
1. Описать цели, задачи, предметную область - сделано 2018-01-21.
2. Построить предсказательные модели для риска неврологических проявлений болезни [Вильсона-Коновалова](https://ru.wikipedia.org/wiki/Болезнь_Вильсона_—_Коновалова) (БВК), опираясь на <br> * Историю заболевания и симпотомы пациента и его родственников (если доступно). <br> * Особенности генов (минорные аллели), регулирующих свёртываемость крови. <br>Оценить качество предсказания.
    * Классфикаторы: линейная логистическая регрессия, RandomForestClassifier, Yandex CatBoost. <br> Выявление важных групп.
    * Оптимизация стабильности предсказания: <br> Снижение размерности модели путём исключения сильно скоррелированных признаков: <br> * Из признаков цирроза: 'Cirrhosis', 'ChildPugh', 'Advanced'. <br> * Из признаков рост, вес, BMI оставить один: BMI. <br> * По-разному детализировать генетические признаки.
3. Сравнить качество предсказания с генетическими признаками и без них. <br> Выяснить, насколько особенности генов (минорные аллели), регулирующих свёртывающую систему крови, <br> позволяют уточнить прогноз тяжести неврологических проявлений при болезни Вильсона-Коновалова (БВК).
