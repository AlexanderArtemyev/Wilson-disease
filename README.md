...
### Ближайшее
1. Сделать рассчёты в соответствии с логикой презентации данных.
...
1. Обсудить результаты первичого изучения. Осудить аномалии, исправить в данных опечатки. 
...
1. Признаки
    ...
    2. Попробовать один из признаков тяжести цирроза: 'Cirrhosis', 'ChildPugh', 'Advanced'. 
    3. Из признаков рост, вес, BMI оставить один: BMI.
    4. Снижение размерности модели путём исключения других сильно скоррелированных признаков - посмотреть.
1. Классфикаторы: линейная логистическая регрессия (слделано), <br> Добавить RandomForestClassifier, Yandex CatBoost. <br> Выявление важных групп. 
1. Сравнить качество предсказания с генетическими признаками и без них. <br> Выяснить, насколько особенности генов (минорные аллели), регулирующих свёртывающую систему крови, <br> позволяют уточнить прогноз тяжести неврологических проявлений при болезни Вильсона-Коновалова (БВК).
1. Оценка доверительных интервалов: bootsrtap.
