...
2. Рефакторинг: - начато 2018-01-20, основа сделана и выложена на [github](https://github.com/AlexanderArtemyev/Wilson-disease/)
    ...
    * выделить общие для всего проекта объекты и функции.
...
* Интерпретация признаков - feature engineering. Создание эффективных комбинированных признаков.
* Ручной отбор признаков для обучения для снижения размерности пространства признаков.

#### Требования к моделям
* Задача бинарной классификации.
* Поддержка сильной регуляризации - ограничение пространства признаков.
